    ...
    <div>
      ...
      >
        ...
        <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
          <label htmlFor="status-filter" style={{ fontSize: '0.875rem', fontWeight: 500, color: '#475569' }}>
            Status:
          </label>
          <select
            id="status-filter"
        ...
        {/* Sort By */}
        <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
          <label htmlFor="sort-by" style={{ fontSize: '0.875rem', fontWeight: 500, color: '#475569' }}>
            Sort:
          </label>
          <select
            id="sort-by"
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
            <thead>
              <tr style={{ backgroundColor: '#f8fafc', borderBottom: '1px solid #e2e8f0' }}>
                <th style={{ padding: '0.85rem 1rem', fontSize: '0.75rem', fontWeight: 600, color: '#475569', textTransform: 'uppercase' }}>
                  Full Name
                </th>
                <th style={{ padding: '0.85rem 1rem', fontSize: '0.75rem', fontWeight: 600, color: '#475569', textTransform: 'uppercase' }}>
                  Contact Info
              ...
              {leads.map((lead) => (
                ...
                >
                  ...
                  <td style={{ padding: '1rem', fontSize: '0.875rem' }}>
                    <div>{lead.email || '—'}</div>
                    <div style={{ color: '#64748b', fontSize: '0.8rem' }}>{lead.phone || '—'}</div>
                  </td>
                  ...
                  <td style={{ padding: '1rem', fontSize: '0.85rem', color: '#64748b' }}>
                    <div>{lead.source}</div>
                    {lead.form_id && <div style={{ fontSize: '0.75rem' }}>Form: {lead.form_id}</div>}
                  </td>
                  <td style={{ padding: '1rem', fontSize: '0.85rem', color: '#64748b' }}>
