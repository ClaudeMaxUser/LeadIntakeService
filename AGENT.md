...
manually written sections, and architecture decisions." The sections below are filled in *as the
project is built*, not reconstructed from memory at the end.
...
## 2. AI usage log *(living — fill in as you build)*
...
## 3. Architecture decision log *(living — fill in as you build)*
